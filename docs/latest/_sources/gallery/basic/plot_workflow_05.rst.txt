...
.. image-sg:: /gallery/basic/images/sphx_glr_plot_workflow_05_002.png
   :alt: $mode_{0}$ slice: 0  itr: 1.000, $mode_{1}$ slice: 0  itr: 1.000, $mode_{2}$ slice: 0  itr: 1.000, $mode_{3}$ slice: 0  itr: 1.000, $mode_{0}$ slice: 499  itr: 0.100, $mode_{1}$ slice: 499  itr: 0.100, $mode_{2}$ slice: 499  itr: 0.100, $mode_{3}$ slice: 499  itr: 0.100
