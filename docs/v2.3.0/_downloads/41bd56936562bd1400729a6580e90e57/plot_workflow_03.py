...
custom_fiber.create_and_add_new_structure(
    radius=62.5e-6, refractive_index=clad_refractive_index, name="outer-clad"
)

custom_fiber.create_and_add_new_structure(radius=40e-6 / 2, NA=0.13, name="inner-clad")
custom_fiber.create_and_add_new_structure(radius=9.2e-6 / 2, NA=0.13, name="core")
