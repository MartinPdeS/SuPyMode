...
clad_structure.refractive_index = MaterialBank.fused_silica.compute_refractive_index(
    wavelength
...
fiber_list = [
    fiber_loader.load_fiber(
        "DCF1300S_33",
        clad_refractive_index=clad_structure.refractive_index,
    ...
    fiber_loader.load_fiber(
        "DCF1300S_33",
        clad_refractive_index=clad_structure.refractive_index,
        position=clad_structure.cores[3],
    ),
]
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
_ = workflow.plot(plot_type="adiabatic", save_as="test.png")
