...
import SuPyMode
from SuPyMode.directories import doc_css_path


package_name = "SuPyMode"
...
examples_files = ["workflow", "alpha_profile", "validation", "extra"]
...
man_pages = [
    (master_doc, f"{package_name}", f"{package_name} Documentation", [author], 1)
]
