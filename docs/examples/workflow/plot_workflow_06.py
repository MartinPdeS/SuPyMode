...
fiber_list = [
    fiber_loader.load_fiber('DCF1300S_42', clad_refractive_index=clad_refractive_index, position=clad_structure.cores[0]),
    ...
    fiber_loader.load_fiber('DCF1300S_20', clad_refractive_index=clad_refractive_index, position=clad_structure.cores[3])
]
...
boundaries = [
    Boundaries(bottom=BoundaryValue.SYMMETRIC),
    Boundaries(bottom=BoundaryValue.ANTI_SYMMETRIC)
]
