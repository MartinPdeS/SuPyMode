...
public:
    ...
    pybind11::array_t<double> get_index_py() const {return eigen_to_ndarray(this->index, {model_parameters.n_slice});}
    pybind11::array_t<double> get_eigen_value_py() const {return eigen_to_ndarray(this->eigen_value, {model_parameters.n_slice});}
