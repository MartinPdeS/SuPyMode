...
class FibermodesSuperset():
    ...
    def get_mode_field_vs_r(self, itr: float, mode_number: FibermodeSupermode, resolution: int = 100, normalization: str = 'max') -> float:          
    ...
    def get_adiabatic_vs_itr(self, mode_number_0: str, mode_number_1: str, itr_list: list, resolution: int, debug_mode: bool = True) -> DataSet:
        """
    ...
    def get_normalized_coupling(self, fiber, mode_0: FibermodeSupermode, mode_1: FibermodeSupermode, resolution: int = 200) -> float:
        """
        ...
        field_mode_0_vs_r = self.get_normalized_mode_field(mode=mode_0, r_space=r_space, normalization='l2')
        field_mode_1_vs_r = self.get_normalized_mode_field(mode=mode_1, r_space=r_space, normalization='l2')
    ...
    def get_overlap_integral(self, fiber, mode_0: FibermodeSupermode, mode_1: FibermodeSupermode, resolution: int = 200, normalization: str = 'l2') -> float:
        bound = fiber.radius_boundary * 1.2

        r_space = numpy.linspace(0, bound, resolution)
        
        field_mode_0_vs_r = self.get_normalized_mode_field(mode=mode_0, r_space=r_space, normalization=normalization)
        field_mode_1_vs_r = self.get_normalized_mode_field(mode=mode_1, r_space=r_space, normalization=normalization)
    ...
    def get_overlap_integral_vs_itr(self, mode_number_0: str, mode_number_1: str, itr_list: numpy.ndarray, resolution: int, debug_mode: bool = True) -> DataSet:
        """
    ...
    def get_normalized_coupling_vs_itr(self, mode_number_0: str, mode_number_1: str, itr_list: numpy.ndarray, resolution: int, debug_mode: bool = True) -> DataSet:
        """
...
class FiberModeSolver():
    ...
    def get_field_distribution(self, itr: float, resolution: int, mode_numbers: list, normalization: str = 'max') -> list:
        """
    ...
    def plot_field_distribution(self, itr: float, resolution: int, mode_numbers: list, normalization: str = 'max', add_interfaces: bool = True) -> SceneList:
        """
        Gets the fibermode field distribution.
    ...
    def get_normalized_coupling(self, itr_list: numpy.ndarray, resolution: int, mode_couples: list, debug_mode: bool = True) -> list:
        """
    ...
    def plot_normalized_coupling(self, itr_list: numpy.ndarray, resolution: int, mode_couples: list) -> SceneList:
        """
    ...
    def get_beta_vs_itr(self, mode_numbers: list, itr_list: numpy.ndarray, debug_mode: bool = True) -> list:
        """
