...
def _ModeCoupling(SuperMode0, SuperMode1, k, Profile, iter):
...
def ModeCoupling(SuperMode0, SuperMode1, k, Profile, Gradient, iter):
        assert SuperMode0.DegenerateFactor == SuperMode1.DegenerateFactor
        ...
        I = np.trapz( [np.trapz(Ix, dx=1) for Ix in O*Gradient], dx=1)
...
def ModeAdiabatic(SuperMode0, SuperMode1, k, Profile, Gradient, iter):
...
def _ModeAdiabatic(SuperMode0, SuperMode1, k, Profile, iter):
    beta0 = SuperMode0.Slice[iter].Beta
